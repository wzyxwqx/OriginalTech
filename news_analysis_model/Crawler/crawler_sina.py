...
class WebCrawlFromSina(object):
    ...
    def getUrlInfo(self,url):
        ...
        respond.encoding = BeautifulSoup(respond.content, "html.parser").original_encoding
        ...
        for paragraph in part:
            ...
            '''Prob: Standard frequency of Chinese occurrence among 
    ...
    def CrawlRealtimeCompanyNews(self,firstPage): 
        ...
        if len(self.realtimeNewsURL) == 0:
            ...
            resp.encoding = BeautifulSoup(resp.content, "html.parser").original_encoding 
