...
class MainpageMarket(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'mainpage_market'


class MainpageMessage(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'mainpage_message'


class MainpageShare(models.Model):
    name_text = models.CharField(max_length=20)
    intro_text = models.CharField(max_length=1000)
    company_text = models.CharField(max_length=200)
    hot_index = models.IntegerField()
